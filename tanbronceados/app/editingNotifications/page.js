    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        console.log('notificationID: state.id , notificationTitle: state.title, notificationMessage: state.message', {notificationID: state.id , notificationTitle: state.title, notificationMessage: state.message})
        // Se envía solicitud de registro con los datos del formulario
        try {
        const res = await fetch('/api/editNotification', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ notificationID: state.id , notificationTitle: state.title, notificationMessage: state.message }),
        });
